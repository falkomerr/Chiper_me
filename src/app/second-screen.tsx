...
export const SecondScreen = () => {
  return (
    <div className="mx-auto h-[74.75rem] w-screen px-6">
      <Image
        className="absolute right-1/2 left-1/2 z-0 h-[72.75rem] w-[calc(100vw-32px)] -translate-x-1/2 rounded-lg border border-[#262626] bg-black object-cover"
      ...
      <div className="relative z-[999] mx-auto mb-4 flex max-w-[60.5rem] flex-nowrap gap-4 overflow-hidden px-4 text-white">
        <motion.div
          ...
          viewport={{ once: true }}
          className="w-full max-w-[22.875rem] gap-y-4 rounded-lg border border-[#262626] bg-black p-4">
          <div>
            <Image
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative flex w-full max-w-[37rem] items-end gap-y-4 overflow-hidden rounded-lg border border-[#262626] bg-black p-4">
